...
class EnfoqueDiferencialView(PredioMixin, CreateView):
	form_class = FormEnfoqueDiferencial
	success_url = '/'
	template_name = 'enfoque_diferencial/index.html'

class EnfoqueDiferencialUpdateView(UpdateModelMixin, UpdateView):
	model = EnfoqueDiferencial
	form_class = FormEnfoqueDiferencial
	success_url = '/'
	template_name = 'enfoque_diferencial/edit/index.html'